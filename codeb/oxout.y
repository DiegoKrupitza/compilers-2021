...
yyyRSU(26,1,1,5);
yyyGenIntNode();
yyyAdjustINRC(yyyRCIL+240,yyyRCIL+240);/*yyyPrune(26);*/}}|   ID
                        {if(yyyYok){
yyyRSU(27,1,1,5);
yyyGenIntNode();
...
yyyRSU(66,1,1,6);
yyyGenIntNode();
yyyAdjustINRC(yyyRCIL+651,yyyRCIL+654);}}|   ParamsExprLoop Expr
                        {if(yyyYok){
yyyRSU(67,2,1,6);
yyyGenIntNode();
...
yyyRSU(68,2,1,6);
yyyGenIntNode();
yyyAdjustINRC(yyyRCIL+660,yyyRCIL+663);}}|   ParamsExprLoop Expr ',' 
                        {if(yyyYok){
yyyRSU(69,3,1,6);
yyyGenIntNode();
